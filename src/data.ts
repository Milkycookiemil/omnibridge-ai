...
export const dummyData: DummyData = {
  ...
  summaryCards: [
    ...
    { time: "18:45", text: "비용 구조: BYOS로 스토리지 ≈ 0", inkGroupId: "ink-4", timestamp: 1125 }
  ],
  taskBinding: { trigger: "12:30", text: "'중간고사 12월 5일' 일정을 캘린더에 추가할까요?" },
  searchSuggestions: ["교수님이 9블록 강조한 부분", "수익 구조 설명", "BYOS가 뭐였지", "전환 트리거"],
  recentNotes: [
    ...
    { title: "졸업 작품 회의록", date: "지난주", snippet: "스토리보드 초안 완성. API 연동 부분 확인 필요." }
  ]
};
