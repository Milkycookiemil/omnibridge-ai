...
import { deletePdf, deleteCaptureSlides, forgetPdfFile, deletePdfLocal } from './pdfStore';
...
export async function deleteNote(id: string): Promise<void> {
  ...
  if (note.style === 'pdf') { void deletePdf(id); forgetPdfFile(id); void deletePdfLocal(id); }
