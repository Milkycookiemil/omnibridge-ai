...
function Privacy() {
  return (
    <>
      ...
      <P>
        <b>국외 이전 안내</b>: 위 Supabase와 Anthropic은 <b>미국</b>에 소재하므로, 서비스 이용 과정에서
        이용자의 개인정보가 미국으로 이전·처리됩니다. ▸이전받는 자: Supabase Inc.(계정·노트 저장),
        Anthropic PBC(AI 요약을 켠 경우에 한한 전사 텍스트) ▸이전되는 국가: 미국 ▸이전 항목·목적·보유기간:
        본 방침 제1·2·4조에 기재된 바와 같음 ▸이전을 거부하는 방법·효과: 회원 탈퇴 시 이전이 중단되며,
        AI 요약은 설정에서 끄면 Anthropic으로의 전송이 발생하지 않습니다(핵심 기능은 계속 이용 가능).
      </P>
